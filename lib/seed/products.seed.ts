...
export const products = [
...

  {
    ...
    maxMarkupPercent: 30,
    status: "ACTIVE",
    storageCondition: "Store below 25°C in original packaging. Keep dry.",
  },

  {
    ...
    maxMarkupPercent: 25,
    status: "ACTIVE",
    storageCondition: "Store at 15°C–30°C.",
  },

  {
    seedId: "prod-artemether-lumefantrine",
    name: "Artemether 80mg + Lumefantrine 480mg (ACT Forte)",
    ...
    strength: "80mg/480mg (Forte 6-tablet single course)",
    dosageForm: "Oral Tablet",
    ...
    maxMarkupPercent: 20,
    status: "ACTIVE",
    storageCondition: "Store below 30°C in moisture-proof packaging.",
  },

  {
    ...
    activeIngredient: "Ascorbic Acid (Vitamin C) + Zinc 10mg",
    strength: "1000mg",
    ...
    maxMarkupPercent: 25,
    status: "ACTIVE",
    storageCondition: "Keep tube tightly closed in a cool, dry place.",
  },

  {
    ...
    maxMarkupPercent: 25,
    status: "ACTIVE",
    storageCondition: "Store at 20°C–25°C.",
  },

  {
    ...
    activeIngredient: "Omeprazole (Enteric Coated Pellets)",
    strength: "20mg",
    ...
    maxMarkupPercent: 25,
    status: "ACTIVE",
    storageCondition: "Store in moisture-resistant container below 25°C.",
  },

  {
    seedId: "prod-cough-syrup",
    name: "Expectorant Cough Syrup with Menthol (100ml)",
    ...
    activeIngredient: "Diphenhydramine HCl + Ammonium Chloride + Menthol",
    ...
    maxMarkupPercent: 25,
    status: "ACTIVE",
    storageCondition: "Do not freeze. Keep away from light.",
  },
...

  {
    ...
    maxMarkupPercent: 30,
    status: "ACTIVE",
    storageCondition: "Protect from moisture and light.",
  },
] as const
...
export async function seedProducts() {
  ...
  for (const product of products) {
    const found = seededProducts.find((item) => item.name === product.name)

    if (found) {
      productIds[product.seedId] = found._id.toString()
    }
  }
