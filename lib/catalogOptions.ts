...
export const DOSAGE_FORM_GROUPS: OptionGroup[] = [
  {
    ...
    options: [
      ...
      {
        value: "Dispersible Tablet",
        label: "Oral Dispersible / Chewable Tablet",
      },
      {
        value: "Extended-Release Tablet",
        label: "Oral Extended / Sustained-Release Tablet",
      },
      ...
      {
        value: "Oral Powder / Granules",
        label: "Oral Granules / Sachet Powder",
      },
  ...
  },
  {
    ...
    options: [
      ...
      {
        value: "Dry Powder for Oral Suspension",
        label: "Dry Powder for Oral Suspension",
      },
    ],
  },
  {
    ...
    options: [
      {
        value: "Injectable Solution (IV/IM)",
        label: "Injectable Solution (IV/IM Ampoule)",
      },
      {
        value: "Infusion Solution (IV)",
        label: "Intravenous (IV) Infusion Fluid",
      },
      {
        value: "Powder for Injection (Vial)",
        label: "Lyophilized Powder for Injection (Vial + Diluent)",
      },
      {
        value: "Injectable Suspension (Cold-Chain)",
        label: "Injectable Suspension (Cold-Chain Insulin / Vaccine)",
      },
      {
        value: "Pre-Filled Syringe (PFS)",
        label: "Pre-Filled Syringe (PFS / Subcutaneous)",
      },
      {
        value: "Peritoneal Dialysis Solution",
        label: "Peritoneal Dialysis / Irrigation Solution",
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        value: "Sterile Ophthalmic Eye Drops",
        label: "Sterile Ophthalmic Eye Drops",
      },
  ...
  },
  {
    ...
    options: [
      {
        value: "Metered Dose Inhaler (MDI)",
        label: "Metered Dose Inhaler (MDI Aerosol)",
      },
      {
        value: "Dry Powder Inhaler (DPI)",
        label: "Dry Powder Inhaler (DPI Rotacap)",
      },
      {
        value: "Nebulizer Inhalation Solution",
        label: "Nebulizer Inhalation Solution",
      },
    ],
  },
  {
    ...
    options: [
      ...
      {
        value: "Vaginal Cream with Applicator",
        label: "Vaginal Cream with Applicator",
      },
    ],
  },
  {
