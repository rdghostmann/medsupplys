...
export type CreditStatus =
  ...
  | "DEFAULTED"
  | "CLOSED"
export type VerificationResult = "APPROVED" | "FLAGGED" | "PENDING" | "REJECTED"
...
export const unitTypesBySupplier = {
  importer: ["carton", "pack"],

  distributor: ["pack", "unit"],
...
export interface Notification {
  ...
  recipientRole: "buyer" | "supplier" | "pharmacist" | "admin"
