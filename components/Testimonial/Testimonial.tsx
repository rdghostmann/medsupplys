...
export default function Testimonial() {
  ...
  return (
    <section className="py-10 bg-white overflow-hidden" id="testimonials-section">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mb-16 lg:mb-10 ">
        ...
        <div className="flex flex-col items-center text-center mb-2 lg:mb-5 ">
          ...
          <h2 className="w-11/12 mx-auto text-2xl sm:text-3xl font-sora font-semibold text-center mb-2 tracking-tight">            Trusted by Healthcare Professionals
          </h2>
          <p className="text-slate-600 text-center mb-10 max-w-lg mx-auto"> From hospital procurement teams to licensed distributors — real stories from the MedSupply community.</p>
