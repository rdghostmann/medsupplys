...
export const TrustBadge: React.FC<TrustBadgeProps> = ({
  ...
  return (
    <span
      className={`inline-flex items-center rounded-full border font-medium tracking-tight whitespace-nowrap shadow-2xs ${config.classes} ${sizeClasses[size]} ${className}`}
    >
