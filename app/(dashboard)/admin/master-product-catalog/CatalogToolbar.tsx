      ...
      <div className="flex flex-col items-center justify-between gap-3 sm:flex-row">
        ...
        <div className="relative w-full sm:w-96">
          ...
          <input
            ...
            className="w-full rounded-xl border border-slate-200 bg-slate-50 py-2 pl-9 pr-9 text-xs text-slate-900 transition placeholder:text-slate-400 focus:border-blue-500 focus:bg-white focus:outline-none"
          />
