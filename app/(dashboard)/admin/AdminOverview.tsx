  ...
  const handleResetSeedData = async () => {
    ...
    try {
      ...
      toast.error("Reset failed", {
        description: "Unable to restore the demo seed data. Please try again.",
      })
    } finally {
      ...
      <div className="relative flex flex-col items-start justify-between gap-4 sm:flex-row sm:items-center">
        <div className="">
          <h2 className="font-display flex items-center gap-2 text-lg font-bold text-slate-900">
            ...
            <span>MediSupply Platform Operations & Governance</span>
          </h2>
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-xs leading-relaxed text-slate-500">
              NAFDAC GDP compliance validation, Paystack webhook listener, and
              atomic transaction locks operational.
            </p>
          </div>
        </div>
