...
const WEIGHT_CONFIG = [
  ...
  },
  {
    ...
    description: "Prioritizes suppliers offering competitive unit prices.",
    icon: CircleDollarSign,
  },
  {
    key: "supplierTypeWeight",
    label: "Supplier Tier Hierarchy",
    description: "Factors importer, distributor, and retailer supplier tiers.",
    icon: Layers3,
  },
  {
    ...
    <div className="rounded-xl border bg-card p-5 shadow-sm">
      ...
      <div className="mb-5 flex items-start justify-between gap-4">
        <div>
          ...
          <p className="mt-1 text-sm text-muted-foreground">
            Reference these weights when calibrating the supplier matching
            algorithm.
          </p>
        </div>
      ...
      <div className="mt-5 rounded-lg border border-dashed bg-muted/30 p-3">
        <p className="text-xs leading-relaxed text-muted-foreground">
          These values represent the current platform matching configuration.
          Changing the calibration values will affect how supplier candidates
          are ranked for future procurement requests.
        </p>
      </div>
    </div>
  )
