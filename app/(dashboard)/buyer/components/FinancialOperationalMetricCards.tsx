      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
        ...
        <div className="bg-white p-5 rounded-2xl border border-slate-200 shadow-xs hover:border-amber-200 transition">
          ...
          <div className="flex items-center justify-between text-[11px] mt-3 pt-3 border-t border-slate-100">
            ...
            <button
              type="button"
              onClick={()=>{router.push("/buyer/procurement-sourcing")}}
              className="cursor-pointer text-amber-700 font-semibold hover:underline disabled:cursor-default disabled:no-underline disabled:opacity-60"
            >
              View Queue →
            </button>
          </div>
